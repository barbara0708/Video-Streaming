...
class AnalyticsApi {
     ...
     */
    async getLiveStreamsPlays({ from, dimension, to, filter, currentPage, pageSize, }) {
        const queryParams = {};
        queryParams.headers = {};
        if (from === null || from === undefined) {
            throw new Error('Required parameter from was null or undefined when calling getLiveStreamsPlays.');
        }
        if (dimension === null || dimension === undefined) {
            throw new Error('Required parameter dimension was null or undefined when calling getLiveStreamsPlays.');
        }
        // Path Params
        ...
        if (from !== undefined) {
            urlSearchParams.append('from', ObjectSerializer_1.default.serialize(from, 'string', 'date'));
        }
        if (to !== undefined) {
            urlSearchParams.append('to', ObjectSerializer_1.default.serialize(to, 'string', 'date'));
        }
        if (dimension !== undefined) {
            urlSearchParams.append('dimension', ObjectSerializer_1.default.serialize(dimension, "'liveStreamId' | 'emittedAt' | 'country' | 'deviceType' | 'operatingSystem' | 'browser'", ''));
        }
        if (filter !== undefined) {
            urlSearchParams.append('filter', ObjectSerializer_1.default.serialize(filter, 'string', ''));
        }
        ...
        return this.httpClient
            ...
            .then((response) => ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'AnalyticsPlaysResponse', ''));
    }
    /**
     ...
     * @param { number } searchParams.pageSize Results per page. Allowed values 1-100, default is 25.
     */
    async getVideosPlays({ from, dimension, to, filter, currentPage, pageSize, }) {
        const queryParams = {};
        queryParams.headers = {};
        if (from === null || from === undefined) {
            throw new Error('Required parameter from was null or undefined when calling getVideosPlays.');
        }
        if (dimension === null || dimension === undefined) {
            throw new Error('Required parameter dimension was null or undefined when calling getVideosPlays.');
        }
        // Path Params
        ...
        if (dimension !== undefined) {
            urlSearchParams.append('dimension', ObjectSerializer_1.default.serialize(dimension, "'videoId' | 'emittedAt' | 'country' | 'deviceType' | 'operatingSystem' | 'browser'", ''));
        }
        if (filter !== undefined) {
            urlSearchParams.append('filter', ObjectSerializer_1.default.serialize(filter, 'string', ''));
        }
