...
class RawStatisticsApi {
    ...
    async listLiveStreamSessions({ liveStreamId, period, currentPage, pageSize, }) {
        ...
        if (period === null || period === undefined) {
            throw new Error('Required parameter period was null or undefined when calling listLiveStreamSessions.');
        }
        // Path Params
    ...
    async listVideoSessions({ videoId, period, metadata, currentPage, pageSize, }) {
        ...
        if (period === null || period === undefined) {
            throw new Error('Required parameter period was null or undefined when calling listVideoSessions.');
        }
        // Path Params
